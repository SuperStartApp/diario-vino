...
import { Wine, MapPin, Calendar, Percent, DollarSign, Download, ArrowLeft, Edit, CheckCircle } from 'lucide-react';
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <InfoRow 
              ...
              label="Prezzo" 
              value={wine.prezzo_acquisto ? `€ ${wine.prezzo_acquisto}` : 'Non specificato'} 
            />
          </div>
          ...
          <div className="flex flex-col items-center justify-center bg-gray-50 rounded-2xl p-6 border-2 border-dashed border-gray-200">
            ...
            <button 
              onClick={onSnooze}
              className="mb-4 flex items-center gap-2 text-xs text-green-600 font-bold hover:underline"
            >
